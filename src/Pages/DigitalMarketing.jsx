					...
					<div className="col-lg-7 ">
						<div className="home-wrapper-dg">
							...
							<div className="buttons-dv-dg comn-main">
								<Link to='/contact' className='btn-proposal-dg'>GET A PROPOSAL <img src={arroww} className='arrow-icon-white-btn' alt="Icon" /></Link>
								<Link to='/' className='btn-proposal-dg-no-bg'>Consult with Us <img src={arroww} className='arrow-icon-white-btn' alt="Icon" /></Link>
							</div>
						...
						<div className="col-lg-8">
							<div className="inner-fearless-dg">
								...
								<div className="buttons-dg-fearless comn-main hide-mob-btn">
									<Link to='/' className='btn-proposal-dg'>Learn More About Us <img src={arroww} className='arrow-icon-white-btn' alt="Icon" /></Link>
								</div>
							</div>
						</div>
