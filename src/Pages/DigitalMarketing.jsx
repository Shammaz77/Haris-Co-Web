...
import f1 from '../Assets/DigitalMarketing/f1.webp'
				...
				<div className="container-main">
					<div className="navbar-dg">
						...
						<div className="buttons-dg comn-main">
							<Link to='/contact' className='btn-proposal-dg'>  GET A PROPOSAL <img src={arroww} className='arrow-icon-white-btn' alt="" /></Link>
						</div>
					</div>
				</div>
			</div>
				...
				<div className="row">
					<div className="col-lg-7 ">
						<div className="home-wrapper-dg">
							...
							<div className="buttons-dv-dg comn-main">
								<Link to='/contact' className='btn-proposal-dg'>GET A PROPOSAL <img src={arroww} className='arrow-icon-white-btn' alt="" /></Link>
								<Link to='/' className='btn-proposal-dg-no-bg'>Consult with Us <img src={arroww} className='arrow-icon-white-btn' alt="" /></Link>
							</div>
							...
							<div className="inner-box-clients-section">
								...
								<Slider {...clientsSlider}>
									<div className="image-slietnts-sliders">
										<img src={cl1} className='sliderimageclients' alt="" />
									</div>
									<div className="image-slietnts-sliders">
										<img src={cl1} className='sliderimageclients' alt="" />
									</div>
					...
					<div className="row">
						<div className="col-lg-8">
							<div className="inner-fearless-dg">
								...
								<div className="buttons-dg-fearless comn-main hide-mob-btn">
									<Link to='/' className='btn-proposal-dg'>Learn More About Us <img src={arroww} className='arrow-icon-white-btn' alt="" /></Link>
								</div>
							</div>
						</div>
						<div className="col-lg-4">
							...
							<div className="buttons-dg-fearless comn-main no-showww full-width">
								<Link to='/' className='btn-proposal-dg full-width text-center'>Learn More About Us <img src={arroww} className='arrow-icon-white-btn' alt="" /></Link>
							</div>
						</div>
					</div>
				</div>
							...
							<div className="fame-inner-dg">
								...
								<div className="awards-images-dg">
									<Slider {...settings}>
										...
										<div className="award-image-dg">
											<img src={b} className='award-img-pc' alt="" />
							...
							<div className="slider-item-mobile-what-we">
								<Slider {...settingsWhatwedo}>
									<div className="items-what-we-do-main">
										<img src={s11} className='main-image-whatwedo' alt="" />
										<h3>SEO</h3>
										...
										<div className="btn-view-more-dv">
											<Link to='/contact' className='btn-proposal-dg'>View More <img src={arroww} className='arrow-icon-white-btn' alt="" /></Link>
										</div>
									</div>
									<div className="items-what-we-do-main">
										<img src={team2} className='main-image-whatwedo' alt="" />
									...
									<div className="items-what-we-do-main">
										<img src={team3} className='main-image-whatwedo' alt="" />
										<h3>Social Media</h3>
									...
									<div className="items-what-we-do-main">
										<img src={team4} className='main-image-whatwedo' alt="" />
									...
									<div className="items-what-we-do-main">
										<img src={team5   } className='main-image-whatwedo' alt="" />
										<h3>Branding</h3>
				...
				<div className="headlines-main-dvv-dg">
					<Slider {...settingsHeadlinesOne}>
						<div className="featured-img-dv-main">
							<img src={f1} className='dg-feature-img' alt="" />
							<div className="bgcolor-dg"></div>
							<img src={arrowhover} className='hover-arrow-main-dg' alt="" />
						</div>
						<div className="featured-img-dv-main">
							<img src={f2} className='dg-feature-img' alt="" />
							<div className="bgcolor-dg"></div>
							<img src={arrowhover} className='hover-arrow-main-dg' alt="" />
						</div>
						<div className="featured-img-dv-main">
							<img src={f3} className='dg-feature-img' alt="" />
							<div className="bgcolor-dg"></div>
							<img src={arrowhover} className='hover-arrow-main-dg' alt="" />
						</div>
						<div className="featured-img-dv-main">
							<img src={f4} className='dg-feature-img' alt="" />
							<div className="bgcolor-dg"></div>
							<img src={arrowhover} className='hover-arrow-main-dg' alt="" />
						</div>
					</Slider>
							...
							<div className="col-lg-12">
								<div className="lets-discuss-main-dg">
									...
									<div className="righthalf-dg-discss comn-main">
										<Link to='/' className='btn-proposal-dg'>Consult Us <img src={arroww} className='arrow-icon-white-btn' alt="" /></Link>
									</div>
								</div>
							</div>
						</div>
					...
					<div className="row">
						...
						<div className="col-lg-6 pos-main">
							<div className="get-call-back-dg-pink">
								...
								<form className='form-get-call-back-dg'>
									<div className="row">
										<div className="col-lg-6">
										...
										<div className="col-lg-12">
											<div className="buttons-social-media comn-main flx-spabtw">
												<Link to='/' className='btn-proposal-dg'>GET A PROPOSAL <img src={arroww} className='arrow-icon-white-btn' alt="" /></Link>
												<div className="icons-social-media-dg">
													<img src={instagram} className='icones-social-media-dg-img' alt="" />
													<img src={twitter} className='icones-social-media-dg-img' alt="" />
													<img src={facebook} className='icones-social-media-dg-img' alt="" />
													<img src={linkedin} className='icones-social-media-dg-img right-no' alt="" />
												</div>
											</div>
										</div>
									</div>
					...
					<div className="row">
						<div className="col-lg-3">
							<div className="footer-box-dg-main">
								<img src={footerlogo} className='footer-logo-img-dg' alt="" />
								<img src={google} className='google-logo' alt="" />
								<div className="icons-social-media-dg-footer">
									<img src={instagram} className='icones-social-media-dg-imgs' alt="" />
									<img src={twitter} className='icones-social-media-dg-imgs' alt="" />
									<img src={facebook} className='icones-social-media-dg-imgs' alt="" />
									<img src={linkedin} className='icones-social-media-dg-imgs right-no' alt="" />
								</div>
							</div>
						</div>
						<div className="col-lg-3">
						...
						<div className="col-lg-3">
							<div className="footer-box-dg-main flx-link">
								...
								<ul className='footer-icondnd'>
									<li><Link to='/'>
										<img src={callfooter} className='footer-item-box-img-icon-dg' alt="" />
										+91 8075 040 330</Link>
									</li>

									<li><Link to='/'>
										<img src={emailfooter} className='footer-item-box-img-icon-dg' alt="" />
										bd@harisand.co</Link>
									</li>

									<li><Link to='/'>
										<img src={locationf} className='footer-item-box-img-icon-dg' alt="" />
